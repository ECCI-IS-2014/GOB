...
<?php echo $this->Form->create('Valuesdatatype'); ?>
	<fieldset>
		<legend><?php echo __('Edit Valuesdatatype'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Valuesdatatype.Id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Valuesdatatype.Id'))); ?></li>
