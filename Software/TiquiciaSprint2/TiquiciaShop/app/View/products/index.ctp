...
<td><?php echo $this->Html->link($product['Product']['name'],array("controller" => "Products",
                                                   "action" => "description",
                                                   $product['Product']['id']));?></td>
<td><?php echo $this->Html->image('uploads/product/filename/'.$product['Product']['filename'],array('alt'=>$product['Product']['name'],'width'=>'100')); ?></td>
