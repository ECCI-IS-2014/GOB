...
############################################# Selector a ####################################################
// select 1
echo $this->Html->link('Nueva Categoria', '/Categories/add_category');
...
// select 2
echo $this->Html->link('Nueva Subcategoria', '/Subcategories/add_subcategory');
...
// select 3
echo $this->Html->link('Nueva Subsubcategoria', '/Subsubcategories/add_subsubcategory');
